...
public class MoveMotor : MonoBehaviour {
	...
	void FixedUpdate() 
	{
		...
		GetComponent<Rigidbody>().AddForce(deltaVelocity * moveSnap, ForceMode.Acceleration);
		...
		if (faceDir == Vector3.zero) {
			...
			GetComponent<Rigidbody>().angularVelocity = Vector3.up * rotationAngle * turnSmoothing;
		}
	}
